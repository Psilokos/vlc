...
digraph player_states {
  label="Player states";
  new [style="invis"];
  idle [label="Idle" URL="@ref VLC_PLAYER_STATE_IDLE"];
  ...
  new -> idle [label="vlc_player_New()" URL="@ref vlc_player_New" fontcolor="green3"];
  idle -> started [label="vlc_player_SetCurrentMedia()\n+\nvlc_player_Start()" URL="@ref vlc_player_Start" fontcolor="darkgreen"];
...
#define VLC_PLAYER_TITLE_MENU         0x01 /* Menu title */
#define VLC_PLAYER_TITLE_INTERACTIVE  0x02 /* Interactive title. Playback position has no meaning. */
...
struct vlc_player_title
{
    ...
    /** VLC_PLAYER_TITLE_MENU or VLC_PLAYER_TITLE_INTERACTIVE */
    unsigned flags;

    size_t chapter_count;
    const struct vlc_player_chapter *chapters;
};
struct vlc_player_title_list; /* opaque */
...
struct vlc_player_cbs
{
    ...
    void (*on_record_changed)(vlc_player_t *player,
    ...
    void (*on_vout_fullscreen_changed)(vlc_player_t *player,
        bool is_fullscreen, void *data);

    void (*on_aout_volume_changed)(vlc_player_t *player,
        audio_output_t *aout, float volume, void *data);
    void (*on_aout_mute_changed)(vlc_player_t *player,
        audio_output_t *aout, bool muted, void *data);
};
