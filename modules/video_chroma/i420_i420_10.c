/*****************************************************************************
 * i420_i420_10.c : Planar YUV 4:2:0 8bits to Planar YUV 4:2:0 10bits
 *****************************************************************************
...
static picture_t *      I420_I420_10_Filter(filter_t *, picture_t *);
static void             I420_I420_10(filter_t *filter,
 ...
 *****************************************************************************/
vlc_module_begin ()
    set_description( N_("YUV 420 8-bits planar to YUV 420 10-bits planar conversions") )
...
Create(vlc_object_t *obj)
{
    ...
    if ((fmt_out->i_chroma != VLC_CODEC_I420_10L &&
         fmt_out->i_chroma != VLC_CODEC_I420_10B) ||
    ...
    filter->pf_video_filter = I420_I420_10_Filter;
...
/*****************************************************************************
 * planar YUV I420 8-bits to planar YUV I420 10-bits
 *****************************************************************************/

VIDEO_FILTER_WRAPPER(I420_I420_10)

static void
I420_I420_10(filter_t *filter, picture_t *src, picture_t *dest)
{
    size_t      pitches[3] =
    {
    ...
    CopyFromI420ToI420_10(dest, planes, pitches,
                          src->format.i_y_offset +
                          src->format.i_visible_height,
                          &filter->p_sys->cache,
                          dest->format.i_chroma == VLC_CODEC_I420_10B);
}
