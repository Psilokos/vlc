                       ...
                       vlc_value_t oldval, vlc_value_t newval, void *p_data)
{
    ...
    static struct vlc_player_cbs const cbs =
    {
        .on_state_changed = player_on_state_changed,
    };
    vlc_player_AddListener(player, &cbs, p_intf);
...
static int Open(vlc_object_t *p_this)
{
    ...
    var_AddCallback(p_sys->playlist, "input-current", ItemChange, p_intf);
...
static void Close(vlc_object_t *p_this)
{
    ...
    var_DelCallback(p_sys->playlist, "input-current", ItemChange, p_intf);
